    ...
    fetch(url)
      ...
      .then(products => {
        ...
        products.forEach(product => {
          ...
          const productStock = product.stock || 0;  // Use the stock value from your product data
          ...
          const productHTML = `
            <div class="col">
              <div class="product-item">
                ...
                <h3>${product.name}</h3>
                <span class="qty">Stock: ${productStock} Units</span> <!-- Display stock -->
                <span class="rating">
                ...
                <div class="d-flex align-items-center justify-content-between">
                  <div class="input-group product-qty">
                    ...
                    <input type="text" class="form-control input-number quantity-input" value="1" data-stock="${productStock}">
                    <span class="input-group-btn">
